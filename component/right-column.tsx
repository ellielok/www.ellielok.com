...
export function Intro() {
  return (
    <div className="text-base leading-7 space-y-10">
      <div className="">
        I am an aspiring {hl('full-stack developer')} skilled in React, TypeScript, and
        modern CSS frameworks. Passionate about creating responsive, user-friendly web applications, I focus on combining thoughtful design with solid engineering for performance and accessibility. Currently completing my Master of Information Technology at Monash University, I plan to reside in {hl('Melbourne, Australia')}.
      </div>
      <div className=" ">
        Previously, I worked as a {hl('Senior Advertising Specialist')} at{' '}
        {hl('Fastlane','https://fstln.io/en')}, where I gained deep experience in digital marketing
...
export default function RightColumn() {
  return (
    <div className="space-y-10 flex-4 scroll-smooth lg:py-25 lg:px-10 xl:px-0">
      ...
      >
        View Full Résumé < ExternalLink className='w-4 h-4 group-hover:-translate-y-0.5 group-hover:translate-x-0.5'/>
      </a>
        </div>
